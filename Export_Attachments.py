...
#This script will need to be added to an ArcGIS toolboxx to work properly
...
#Add a new field to Attachement table, in this scenario I called the field 'Label'

#join related table and or features back to the attachment table(Start with attachments and move backwards)
#especially if using a 1:M feature to attachment relationship

#field calculate a label used for each picture using a unique ID or a combination of fields, which will provide the
#primary label for each picture

#fields Label, ATTACHMENTID, and ATT_NAME are used to build the final picture filename
